...
int main() {
  ...
  while(1) {
    ...
    cout << "6: Grafico" << endl;
    cout << "8: Rivedi i polinomi inseriti" << endl;
    cout << "9: Esci" << endl;
    cout << "Scegli: ";
    opt = getch();
    ...
    switch(opt) {
      ...
      case '4': {
        ...
        if(g1 >= 3) cout << "Non si puo' fare perche' il polinomio e' di 3^ grado" << endl << endl;
        else if(g1 == 2) {
          ...
          } else cout << "L'equazione e' impossibile" << endl;
        } else {
          float x = -p1[0] / (float)p1[1];
          cout << "La soluzione e' " << x << endl;
        }
        cout << endl << "Il secondo polinomio: " << endl;
        if(g2 >= 3) cout << "Non si puo' fare perche' il polinomio e' di 3^ grado" << endl << endl;
        else if(g2 == 2) {
      ...
      case '5': {
        if(g1 >= 3 || g2 >= 3) cout << "Non si puo' fare perche' entrambi i polinomi possono essere al massimo di 2^ grado" << endl;
        else {
          int dim = max(g1, g2);
          int n[3];
          for (int i = dim; i >= 0; i--) {
          ...
          if(dim == 2) {
            ...
            if(delta > 0) {
              float x1 = (-n[1] + sqrt(delta)) / (2 * n[2]);
              float x2 = (-n[1] - sqrt(delta)) / (2 * n[2]);
              cout << "Le soluzioni sono " << x1 << " e " << x2 << endl;
            } else if(delta == 0) {
              float x = (float)-n[1] / (2 * n[2]);
              cout << "La soluzione e' " << x << endl;
            } else cout << "L'equazione e' impossibile" << endl;
          } else {
            float x = -n[0] / (float)n[1];
            cout << "La soluzione e' " << x << endl;
          }
        }
        break;
      ...
      case '8': {
        system("cls");
        system("title Progetto polinomi - Visualizza");
        printTitle("Visualizzazione polinomi inseriti");
